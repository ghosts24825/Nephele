...
{{setvar::branches::branches}}`;
    ...
    const DEFAULT_INSPO = {
        persona: ['高冷禁欲攻', '温柔腹黑攻', '病娇偏执攻', '年下狼狗攻', '年下忠犬攻', '爹系男友攻', '雅痞流氓攻', '清冷仙尊攻', '阴鸷权臣攻', '傲娇纯情攻', '疯批美人攻', '深情硬汉攻', '毒舌金主攻', '沉稳老干部攻', '阳光健气受', '咸鱼摆烂受', '傲娇女王受', '温润如玉受', '病弱受', '白切黑诱受', '小太阳受', '武力值爆表受', '清贫学霸受', '迟钝天然呆受', '社恐宅男受', '毒舌吐槽受', '明艳张扬受'],
        trope: ['情敌变情人', '死对头变真爱', '宿敌相爱相杀', '先婚后爱', '契约恋爱', '破镜重圆', '追妻火葬场', '单向暗恋转双向', '青梅竹马抵不过天降', '替身文学', '白月光竟是我自己', '救赎与被救赎', '相依为命', '美攻壮受', '强强', '年下养成', '体型差', '肤色差', '高岭之花下神坛', '双向奔赴', '年上', '年下', '一见钟情', '日久生情', '暗恋成真', '双向暗恋'],
